        ...
        children: <Widget>[
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(0.0, 0.0, 1432.0, 2560.0),
                  size: Size(1440.0, 2560.0),
                  pinLeft: true,
                  pinRight: true,
                  pinTop: true,
                  pinBottom: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(-205.5, -63.6, 1851.1, 2687.2),
                  size: Size(1440.0, 2560.0),
                  pinLeft: true,
                  pinRight: true,
                  pinTop: true,
                ...
                Container(),
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(28.0, 27.0, 196.0, 87.0),
                  size: Size(1440.0, 2560.0),
                  pinLeft: true,
                  pinTop: true,
                  fixedWidth: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(1324.7, 22.1, 92.6, 60.4),
                  size: Size(1440.0, 2560.0),
                  pinRight: true,
                  pinTop: true,
                  fixedWidth: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(1094.4, 34.2, 66.3, 42.8),
                  size: Size(1440.0, 2560.0),
                  pinTop: true,
                  fixedWidth: true,
                  fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(1171.0, 34.2, 15.0, 42.8),
                  size: Size(1440.0, 2560.0),
                  pinRight: true,
                  pinTop: true,
                  fixedWidth: true,
                ...
                Container(),
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(271.0, 340.0, 916.0, 846.0),
                  size: Size(1440.0, 2560.0),
                  pinTop: true,
                  fixedWidth: true,
                  fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(474.0, 110.0, 510.0, 167.0),
                  size: Size(1440.0, 2560.0),
                  pinTop: true,
                  fixedWidth: true,
                  fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(116.0, 1249.0, 1208.0, 1507.0),
                  size: Size(1440.0, 2560.0),
                  pinLeft: true,
                  pinRight: true,
                  pinBottom: true,
                  fixedHeight: true,
                  child: Text(
                    'Flexing is an eye exercise that stretches and strengthens the occular muscles in the eye.\n\nHow to perform the flexing exercise:\n\nFace forward and look straight ahead. Look up without moving your head and then look down. \n Do this 10 times.  Next look at the right without moving your head and then to the left again without moving your head.  Do this 10 times.      ',
                    style: TextStyle(
                      fontFamily: 'Franklin Gothic',
                      fontSize: 74,
                      color: const Color(0xffffffff),
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(0.0, 0.0, 1440.0, 2560.0),
                  size: Size(1440.0, 2560.0),
                  pinLeft: true,
                  pinRight: true,
                  pinTop: true,
