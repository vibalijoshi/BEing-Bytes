    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(-4.5, 428.0),
            child: SizedBox(
              width: 385.0,
              child: Text(
                'Last but not least always remember to give your eyes adequate rest by ensuring you get eight hours sleep. If you are \nusing computers, try to rest your eyes for 10 mins away from the screen for every 50 mins work.',
                style: TextStyle(
                  fontFamily: 'Franklin Gothic',
                  fontSize: 26,
                  color: const Color(0xffffffff),
...
const String _svg_xgb3pp =
    '<svg viewBox="117.5 696.5 164.0 3.0" ><path transform="translate(117.5, 696.5)" d="M 0 3 L 164 0" fill="none" stroke="#ffffff" stroke-width="6" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
